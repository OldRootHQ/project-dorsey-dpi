(() => {
  ...
  function render(){
    ...
    data.forEach(c=>{
      ...
      g.appendChild(node("circle",{cx,cy,r:16,fill:"none",stroke:"#44d474","stroke-width":"8",opacity:".1"}));
      g.appendChild(node("circle",{cx,cy,r:8,fill:"#44d474",stroke:"#dffff0","stroke-width":"1.3",class:"point"}));

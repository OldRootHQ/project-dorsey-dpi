(() => {
  const locations = {
    ...
    stdorsey:{id:"LOC-004",name:"St. Dorsey Island",type:"Genesis location",region:"Washington, D.C. area",status:"Established",character:"—",characterUrl:"",dossierUrl:"locations/st-dorsey/",note:"St. Dorsey is a fictional developed island branching from Washington, D.C. into the tidal Potomac. Multiple bridge and highway approaches connect the island to the D.C. road network; Hampton Dynamics occupies the isolated far side of the island.",coords:[-77.0550,38.7550]},
  ...
  const stDorseyGeography = {
    island:{type:"Feature",geometry:{type:"Polygon",coordinates:[[[-77.0580,38.8130],[-77.0490,38.8100],[-77.0450,38.7980],[-77.0440,38.7810],[-77.0450,38.7630],[-77.0470,38.7440],[-77.0490,38.7250],[-77.0520,38.7070],[-77.0580,38.6950],[-77.0650,38.6990],[-77.0690,38.7140],[-77.0680,38.7330],[-77.0660,38.7520],[-77.0650,38.7720],[-77.0650,38.7900],[-77.0630,38.8050],[-77.0580,38.8130]]]}},
    bridges:[

(() => {
  const locations = {
    ...
    stdorsey:{id:"LOC-004",name:"St. Dorsey Island",type:"Genesis location",region:"Washington, D.C. area",status:"Established",character:"—",characterUrl:"",dossierUrl:"locations/st-dorsey/",note:"St. Dorsey is a fictional developed island branching from Washington, D.C. into the tidal Potomac. Multiple bridge and highway approaches connect the island to the D.C. road network; Hampton Dynamics occupies the isolated far side of the island.",coords:[-77.0260,38.7720],boundary:{service:"fictional"}},
  ...
  const stDorseyGeography = {
    island:{type:"Feature",geometry:{type:"Polygon",coordinates:[[[-77.0400,38.8420],[-77.0160,38.8440],[-76.9920,38.8360],[-76.9730,38.8210],[-76.9600,38.8000],[-76.9530,38.7760],[-76.9570,38.7520],[-76.9690,38.7300],[-76.9480,38.7200],[-76.9290,38.7100],[-76.9370,38.6960],[-76.9590,38.6940],[-76.9800,38.7040],[-76.9880,38.7130],[-77.0120,38.7030],[-77.0380,38.7010],[-77.0610,38.7080],[-77.0800,38.7220],[-77.0930,38.7420],[-77.1000,38.7640],[-77.0980,38.7860],[-77.0890,38.8060],[-77.0740,38.8230],[-77.0560,38.8350],[-77.0400,38.8420]]]}},
    bridges:[

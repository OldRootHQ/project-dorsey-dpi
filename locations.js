(() => {
  const locations = {
    ...
    stdorsey:{id:"LOC-004",name:"St. Dorsey Island",type:"Genesis location",region:"Washington, D.C. area",status:"Established",character:"—",characterUrl:"",dossierUrl:"locations/st-dorsey/",note:"St. Dorsey is a fictional developed island branching from Washington, D.C. into the tidal Potomac. Multiple bridge and highway approaches connect the island to the D.C. road network; Hampton Dynamics occupies the isolated far side of the island.",coords:[-76.4690,38.7580],boundary:{service:"fictional"}},
  ...
  const stDorseyGeography = {
    island:{type:"Feature",geometry:{type:"Polygon",coordinates:[[[-76.5270,38.8240],[-76.5130,38.8350],[-76.4920,38.8410],[-76.4690,38.8390],[-76.4480,38.8320],[-76.4300,38.8200],[-76.4170,38.8040],[-76.4090,38.7850],[-76.4060,38.7650],[-76.4080,38.7440],[-76.4130,38.7240],[-76.4210,38.7070],[-76.4120,38.6960],[-76.4050,38.6860],[-76.4140,38.6780],[-76.4280,38.6760],[-76.4410,38.6820],[-76.4520,38.6910],[-76.4710,38.6880],[-76.4910,38.6890],[-76.5090,38.6960],[-76.5220,38.7070],[-76.5290,38.7200],[-76.5280,38.7310],[-76.5200,38.7410],[-76.5120,38.7480],[-76.5170,38.7560],[-76.5280,38.7650],[-76.5370,38.7770],[-76.5400,38.7910],[-76.5380,38.8050],[-76.5330,38.8160],[-76.5270,38.8240]]]}},
    bridges:[
      {name:"WEST HIGHWAY",line:{type:"LineString",coordinates:[[-76.5840,38.7570],[-76.5700,38.7550],[-76.5540,38.7580],[-76.5410,38.7640],[-76.5280,38.7650]]}},
      {name:"NORTH HIGHWAY",line:{type:"LineString",coordinates:[[-76.5150,38.8800],[-76.5070,38.8660],[-76.5010,38.8520],[-76.4960,38.8440],[-76.4900,38.8380]]}}
    ],
    entrance:[-76.5100,38.8210]
  };

  const landmarks = {
    hampton:{id:"SITE-001",name:"Hampton Dynamics Facility",parent:"stdorsey",type:"Historic research facility",region:"St. Dorsey Island",status:"Genesis strike site",character:"—",characterUrl:"",dossierUrl:"locations/st-dorsey/",note:"The Hampton Dynamics facility struck during Genesis. Its isolated coastal campus occupies the island's large outward-projecting southern tract, far from the primary D.C. approaches.",coords:[-76.4140,38.6870],calloutOffset:[44,28]},
    university:{id:"SITE-002",name:"University of Dorsey",parent:"stdorsey",type:"University",region:"St. Dorsey Island",status:"Established",character:"—",characterUrl:"",dossierUrl:"locations/st-dorsey/",note:"University of Dorsey occupies a separate coastal site on St. Dorsey, well away from Hampton Dynamics.",coords:[-76.4240,38.8080],calloutOffset:[46,-24]}
  };

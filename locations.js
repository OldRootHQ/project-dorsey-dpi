(() => {
  const locations = {
    ...
    stdorsey:{id:"LOC-004",name:"St. Dorsey Island",type:"Genesis location",region:"Washington, D.C. area",status:"Established",character:"—",characterUrl:"",dossierUrl:"locations/st-dorsey/",note:"St. Dorsey is a fictional developed island branching from Washington, D.C. into the tidal Potomac. Multiple bridge and highway approaches connect the island to the D.C. road network; Hampton Dynamics occupies the isolated far side of the island.",coords:[-77.0100,38.7660],boundary:{service:"fictional"}},
  ...
  const stDorseyGeography = {
    island:{type:"Feature",geometry:{type:"Polygon",coordinates:[[[-77.0560,38.8260],[-77.0330,38.8310],[-77.0100,38.8290],[-76.9880,38.8210],[-76.9720,38.8080],[-76.9620,38.7930],[-76.9580,38.7750],[-76.9590,38.7570],[-76.9640,38.7420],[-76.9540,38.7310],[-76.9430,38.7200],[-76.9470,38.7080],[-76.9590,38.7000],[-76.9750,38.7030],[-76.9890,38.7090],[-77.0090,38.7050],[-77.0300,38.7070],[-77.0470,38.7150],[-77.0550,38.7280],[-77.0520,38.7390],[-77.0440,38.7470],[-77.0540,38.7540],[-77.0610,38.7660],[-77.0630,38.7810],[-77.0610,38.7970],[-77.0580,38.8130],[-77.0560,38.8260]]]}},
    bridges:[
      {name:"WEST HIGHWAY",line:{type:"LineString",coordinates:[[-77.0670,38.8610],[-77.0800,38.8560],[-77.0840,38.8460],[-77.0790,38.8350],[-77.0670,38.8260]]}},
      {name:"EAST HIGHWAY",line:{type:"LineString",coordinates:[[-76.9870,38.8600],[-76.9740,38.8550],[-76.9690,38.8450],[-76.9760,38.8350],[-76.9910,38.8280]]}}
    ],
    entrance:[-77.0290,38.8390]
  };

  const landmarks = {
    hampton:{id:"SITE-001",name:"Hampton Dynamics Facility",parent:"stdorsey",type:"Historic research facility",region:"St. Dorsey Island",status:"Genesis strike site",character:"—",characterUrl:"",dossierUrl:"locations/st-dorsey/",note:"The Hampton Dynamics facility struck during Genesis. Its isolated coastal campus occupies the island's large outward-projecting southern tract, far from the primary D.C. approaches.",coords:[-76.9410,38.7060],calloutOffset:[44,28]},
    university:{id:"SITE-002",name:"University of Dorsey",parent:"stdorsey",type:"University",region:"St. Dorsey Island",status:"Established",character:"—",characterUrl:"",dossierUrl:"locations/st-dorsey/",note:"University of Dorsey occupies a separate coastal site on St. Dorsey, well away from Hampton Dynamics.",coords:[-76.9650,38.8070],calloutOffset:[46,-24]}
  };

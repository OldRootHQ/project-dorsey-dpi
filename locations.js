(() => {
  const locations = {
    ...
    stdorsey:{id:"LOC-004",name:"St. Dorsey Island",type:"Genesis location",region:"Chesapeake Bay, Maryland",status:"Established",character:"—",characterUrl:"",dossierUrl:"locations/st-dorsey/",note:"St. Dorsey is a fictional developed island in the Chesapeake Bay off Maryland's western shore. Two major highway bridges connect it to the mainland; Hampton Dynamics occupies the isolated outer coast.",coords:[-76.3400,38.6000],boundary:{service:"fictional"}},
